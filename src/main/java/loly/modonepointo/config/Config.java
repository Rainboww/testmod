package loly.modonepointo.config;
...
public class Config {
    ...
    public static String aTestOption = "stuff";
    ...
    public static void readConfig() {
        ...
        try {
            ...
            ModOnePointO.logger.log(Level.ERROR, "Problem loading config file!", e1);
        } finally {
            if (cfg.hasChanged()) {
                cfg.save();
            }
    ...
    private static void initGeneralConfig(Configuration cfg) {
        ...
        aTestOption = cfg.getString("testOption", CATEGORY_GENERAL, aTestOption, "test option");
    }
